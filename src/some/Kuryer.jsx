...
import photo from "../images/girl.svg";
  ...
  return (
    <div className="flex">
      ...
      <div className="w-[1292px] pt-4">
        <Link to="/settings/company-branch/personal/kuryer">
        ...
        <div className="-mt-4 ml-[27%] flex text-[#4094F7]">
          <FaFolder />
          <span className="-mt-1 ml-2 text-black">Халдарова Мухлиса</span>
        </div>
        <div className="pt-4">
          <hr />
          ...
          <div className="p-4">
            ...
            <div className="-mt-36 ml-36 font-semibold text-[#48535B]">
              ...
              <div className="mt-4">
                Должность
                <div className="-mt-4">
                  <select className="-mt-7 ml-28 h-[40px] w-[252px] rounded-md border border-gray-300 p-2 font-normal text-black focus:outline-none">
                    <option>Курьер Oqtepa</option>
                    <option>Курьер Oqtepa</option>
                    <option>Курьер Oqtepa</option>
                  </select>
                </div>
