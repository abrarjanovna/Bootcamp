  ...
  return (
    <div className="flex">
      <div className="h-lvh bg-white w-16">
        <Link to="/dashboard">
          <img className="ml-2 mt-4" src={img} />
        </Link>
        <div className="ml-2 mt-4">
          <Link to="/orders">
            <div className="w-[48px] text-[#6E8BB7] p-[10px] text-2xl hover:bg-[#4094F7] hover:text-white rounded-[6px] transition-all">
              <SlBasket />
            </div>
          </Link>
        </div>
        <div className="w-[48px] ml-2 mt-2 hover:bg-[#4094F7] hover:text-white rounded-[6px] transition-all ">
          <Link to="/clients">
            <div className="text-[#6E8BB7] p-[10px] text-2xl">
              <PiUsers />
            </div>
          </Link>
        </div>
        ...
        <img className="ml-3 mt-[600px]" src={main} />
      </div>
    </div>
  );
};
